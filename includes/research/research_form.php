            ...
            <div class="card border-light shadow-sm p-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="number" class="form-control-custom" id="publicationYear" name="publication_year"
                            placeholder="e.g. 2026" min="1900" max="2100" required>
                    </div>
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-light shadow-sm p-4 h-100">
                ...
                <div class="mb-0">
                    ...
                    <input type="file" class="form-control-custom" id="coverImage" name="cover_image" accept="image/*">
