            ...
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    <div class="table-search-box"><i class="bi bi-search table-search-icon"></i><input type="text"
                            class="table-search-input" placeholder="Search research title or author..."></div>
                </div>
            ...
            <table class="table-custom">
                ...
                <tbody>
                    <?php foreach ($reports as $report): ?><tr>
                        ...
                        <td class="text-center"><a href="#" class="table-btn-action" title="View research report"
                                aria-label="View research report"><i class="bi bi-eye"></i></a></td>
                    </tr><?php endforeach; ?>
                </tbody>
            </table>
        </div>
        <div class="table-footer-control">
            <div class="table-pagination-info">Showing 1 to <?= count($reports) ?> of <?= count($reports) ?> research
                reports</div>
            <nav aria-label="Research report pagination">
