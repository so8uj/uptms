    ...
    <div class="table-card-custom">
            ...
            <div class="row g-3">
                <div class="col-12 col-md-8">
                    <div class="table-search-box"><i class="bi bi-search table-search-icon"></i><input type="text"
                            class="table-search-input" placeholder="Search project, team, or update..."></div>
                </div>
                <div class="col-12 col-md-4"><select class="form-select-custom">
        ...
        <div class="table-responsive">
            <table class="table-custom">
                ...
                <tbody>
                    <?php foreach ($progressUpdates as $item): ?><tr>
                        <td>
                            <div class="table-user-name"><?= htmlspecialchars($item['project']) ?></div>
                            <div class="table-user-sub"><?= htmlspecialchars($item['team']) ?></div>
                        </td>
                        <td><?= htmlspecialchars($item['update']) ?></td>
                        ...
                        <td><?php if ($item['status'] === 'attention'): ?><span
                                class="badge bg-warning-subtle text-warning">Needs Attention</span><?php else: ?><span
                                class="badge bg-success-subtle text-success">On Track</span><?php endif; ?></td>
                        <td class="text-end"><a href="#" class="table-btn-action" title="View update"
                                aria-label="View update"><i class="bi bi-eye"></i></a><a href="#"
                                class="table-btn-action" title="Edit update" aria-label="Edit update"><i
        ...
        <div class="table-footer-control">
            <div class="table-pagination-info">Showing 1 to <?= count($progressUpdates) ?> of
                <?= count($progressUpdates) ?> updates</div>
