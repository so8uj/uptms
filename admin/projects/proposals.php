            ...
            <table class="table-custom">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="#" class="table-btn-action" title="View proposal" aria-label="View proposal"><i
                                    class="bi bi-eye"></i></a>
                            <a href="#" class="table-btn-action" title="Edit proposal" aria-label="Edit proposal"><i
                                    class="bi bi-pencil"></i></a>
                            <button type="button" class="table-btn-action delete" title="Delete proposal"
                                aria-label="Delete proposal"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
