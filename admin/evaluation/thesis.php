    ...
    <div class="table-card-custom">
            ...
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    <div class="table-search-box"><i class="bi bi-search table-search-icon"></i><input type="text"
                            class="table-search-input" placeholder="Search thesis title, author, or ID..."></div>
                </div>
        ...
        <div class="table-responsive">
            <table class="table-custom">
                ...
                <tbody>
                    <?php foreach ($thesisEvaluations as $evaluation): ?><tr>
                        <td>
                            <div class="table-user-name"><?= htmlspecialchars($evaluation['title']) ?></div>
                            <div class="table-user-sub"><?= htmlspecialchars($evaluation['id']) ?></div>
                        </td>
                        <td><?= htmlspecialchars($evaluation['author']) ?></td>
                        <td><?= htmlspecialchars($evaluation['department']) ?></td>
                        <td><?= htmlspecialchars($evaluation['reviewer']) ?></td>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-1"><a href="#" class="table-btn-action"
                                    title="View thesis evaluation" aria-label="View thesis evaluation"><i
                                        class="bi bi-eye"></i></a><a href="#" class="table-btn-action"
                                    title="Edit thesis evaluation" aria-label="Edit thesis evaluation"><i
        ...
        <div class="table-footer-control">
            <div class="table-pagination-info">Showing 1 to <?= count($thesisEvaluations) ?> of
                <?= count($thesisEvaluations) ?> thesis evaluations</div>
            <nav aria-label="Thesis evaluation pagination">
