...
<input type="text" class="table-search-input" placeholder="Search admin by name or email...">
</div>
</div>
...
<td>
<?= htmlspecialchars($admin['last_login']) ?>
</td>
<td>
...
<a href="#" class="table-btn-action" title="View admin" aria-label="View admin">
<i class="bi bi-eye">
</i>
</a>
<a href="#" class="table-btn-action" title="Edit admin" aria-label="Edit admin">
...
<div class="table-pagination-info">Showing 1 to <?= count($admins) ?> of <?= count($admins) ?> admins</div>
