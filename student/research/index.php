...
$research = [
    ["title" => "AI-Based Student Performance Prediction System", "author" => "Mohammad Sobuj", "category" => "Artificial Intelligence", "department" => "Computer Science", "year" => "2026", "type" => "Thesis"],
    ["title" => "Smart Campus Management Using IoT", "author" => "Nusrat Jahan", "category" => "Internet of Things", "department" => "Computer Science", "year" => "2025", "type" => "Research Paper"],
    ["title" => "Secure Data Sharing for Academic Networks", "author" => "Tanvir Hasan", "category" => "Cyber Security", "department" => "Information Technology", "year" => "2026", "type" => "Project"],
];
?>
            ...
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    <div class="table-search-box">
                        ...
                        <input class="table-search-input" placeholder="Search title, author, keyword...">
                    </div>
                </div>
