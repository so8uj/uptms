...
$showBreadcrumb = true;
$breadcrumbs = [
    "Dashboard" => url('teacher/index.php'),
    "My Research" => "",
];
...
$research = [
    ...
    ["title" => "Secure Data Sharing for Academic Networks", "category" => "Cyber Security", "year" => "2026", "status" => "Under Review", "type" => "Project"],
];
?>
    ...
    <div class="table-card-custom">
        <div class="table-header-control">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-3">
                    <a href="<?= url('teacher/research/manage.php?action=create') ?>" class="btn btn-primary w-100">
